...
import Courier from "pdfkit-table/node_modules/pdfkit/js/data/Courier.afm";
import CourierBold from "pdfkit-table/node_modules/pdfkit/js/data/Courier-Bold.afm";
...
registerAFMFonts(
  require.context(
    "pdfkit-table/node_modules/pdfkit/js/data",
    false,
    /Helvetica.*\.afm$/
  )
);
